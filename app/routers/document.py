...
def create_document( request: DocumentRequest, video_id: str, client: Client = Depends(get_client)):
    try:
...
def get_all_document(  video_id: str, api_key: str, client: Client = Depends(get_client)):
